...
// ========== 模拟定位功能 ==========4.19 22：00改231-268增加模拟定位函数
let mockLocationMarker = null;
let mockLocationPoint = null;
...
window.setMockLocation = setMockLocation;
window.clearMockLocation = clearMockLocation;